        ...
        public ActionResult BookInCreate()
        {
            ...
            try
            {
                ...
                Vehicle vehicle = new Vehicle()
                {
                    ...
                    IsInValidEngineNumber = jsonData.VehicleType.IsInValidEngineNumber,
                    ReasonInValidEngineNumber = jsonData.VehicleType.ReasonInValidEngineNumber,
                    IsInValidGasNumber = jsonData.VehicleType.IsInValidGasNumber,
                    ReasonInValidGasNumber = jsonData.VehicleType.ReasonInValidGasNumber,
                    IsInValidVinNumber = jsonData.VehicleType.IsInValidVinNumber,
                    ReasonInValidVinNumber = jsonData.VehicleType.ReasonInValidVinNumber,
                    // arsira 2024-02-02
                ...
                return Json(new { success = true, message = "BookIn saved successfully." }, JsonRequestBehavior.AllowGet);
            }
            catch (JsonException)
            {
        ...
        public ActionResult InspectionCreate()
        {
            ...
            try
            {
                ...
                CarInspection carInspection = new CarInspection()
                {
                    ...
                    Roof = jsonData.Roof,
                    IsFlood = jsonData.IsFlood,
                    BodySummary = jsonData.BodySummary,
                    IsEngineWorks = jsonData.IsEngineWorks,
                    FuelSystemId = jsonData.FuelSystemId,
                    IsLubricatorLow = jsonData.IsLubricatorLow,
                    EngineSystemId = jsonData.EngineSystemId,
                    GearTypeId = jsonData.GearTypeId,
                    IsUseableGeneral = jsonData.IsUseableGeneral,
                    IsSoundAbnormal = jsonData.IsSoundAbnormal,
                    IsLeakFuel = jsonData.IsLeakFuel,
                    IsStainWater = jsonData.IsStainWater,
                    IsMachineLightShow = jsonData.IsMachineLightShow,
                    IsEngineAbnomal = jsonData.IsEngineAbnomal,
                    IsNeedRepair = jsonData.IsNeedRepair,
                    EngineSummary = jsonData.EngineSummary,
                    DriveShaftConditionId = jsonData.DriveShaftConditionId,
                    DriveShaftConditionNote = jsonData.DriveShaftConditionNote,
                    SuspensionConditionId = jsonData.SuspensionConditionId,
                    SuspensionConditionNote = jsonData.SuspensionConditionNote,
                    SuspensionSummary = jsonData.SuspensionSummary,
                    GearSystemId = jsonData.GearSystemId,
                    GearConditionId = jsonData.GearConditionId,
                    DriveShaftId = jsonData.DriveShaftId,
                    Is4WD = jsonData.Is4WD,
                    GearSystemSummary = jsonData.GearSystemSummary,
                    IsUseableSteerWheel = jsonData.IsUseableSteerWheel,
                    IsPowerSteering = jsonData.IsPowerSteering,
                    SteeringSummary = jsonData.SteeringSummary,
                    IsUseableBrake = jsonData.IsUseableBrake,
                    BreakSystemSumary = jsonData.BreakSystemSumary,
                    IsAirCool = jsonData.IsAirCool,
                    IsCompressorAir = jsonData.IsCompressorAir,
                    AirSystemSummary = jsonData.AirSystemSummary,
                    IsUseableGuage = jsonData.IsUseableGuage,
                    WarningLightNote = jsonData.WarningLightNote,
                    GaugeSummary = jsonData.GaugeSummary,
                    IsFrontLightWorking = jsonData.IsFrontLightWorking,
                    IsTurnLightWorking = jsonData.IsTurnLightWorking,
                    IsBackLightWorking = jsonData.IsBackLightWorking,
                    IsBrakeLightWoring = jsonData.IsBrakeLightWoring,
                    IsBetteryWorking = jsonData.IsBetteryWorking,
                    IsHooterWorking = jsonData.IsHooterWorking,
                    IsRoundGaugeWorking = jsonData.IsRoundGaugeWorking,
                    IsNavigator = jsonData.IsNavigator,
                    IsNavigatorBuiltIn = jsonData.IsNavigatorBuiltIn,
                    IsNavigatorCD = jsonData.IsNavigatorCD,
                    IsNavigatorSdcard = jsonData.IsNavigatorSdcard,
                    IsNavigatorNoCD = jsonData.IsNavigatorNoCD,
                    IsNavigatorNoSdcard = jsonData.IsNavigatorNoSdcard,
                    ElectronicNote = jsonData.ElectronicNote,
                    ElectronicSummary = jsonData.ElectronicSummary,
                    LatestUpdatedDate = jsonData.LatestUpdatedDate,
